Algoritmo lista
	...
	Si (num1>num2) Y (num2>num3) Entonces
		Escribir 'Lista ordenada', ' ', num1, ' ', num2, ' ', num3;
	SiNo
		Si (num1>num3) Y (num3>num2) Entonces
			Escribir 'Lista ordenada', ' ', num1, ' ', num3, ' ', num2;
		SiNo
			Si (num2>num1) Y (num1>num3) Entonces
				Escribir 'Lista ordenada', ' ', num2, ' ', num1, ' ', num3;
			SiNo
				Si (num2>num3) Y (num3>num1) Entonces
					Escribir 'Lista ordenada', ' ', num2, ' ', num3, ' ', num1;
				SiNo
					Si (num3>num1) Y (num1>num2) Entonces
						Escribir 'Lista ordenada', ' ', num3, ' ', num1, ' ', num2;
					SiNo
						Si (num3>num2) Y (num2>num1) Entonces
							Escribir 'Lista ordenada', ' ', num3, ' ', num2, ' ', num1;
						FinSi
					FinSi
				FinSi
			FinSi
